...
<div class="inner clearfix"> <div class="content-left fl">
  ...
  <div class="content-right fl">
    ...
    <a href="<?php echo U('/Admin/Groupmall/goodsAddEdit');?>" class="btn btn-success">发布产品</a>
    <form action="<?php echo U('/Admin/Groupmall/Goods/issale');?>/<?php echo ($issale); ?>" method="post">
      ...
      <div class="tabs clearfix mgt10">
        <!--a href="<?php echo U('/Admin/Groupmall/Goods');?>" class="<?php if(($_GET['is_sale']) == ""): ?>active<?php endif; ?> tabs_a fl">全部(<?php echo ($count); ?>)</a-->
        <a href="<?php echo U('/Admin/Groupmall/Goods/issale/1');?>" class='<?php if(($issale) == "1"): ?>active<?php endif; ?> tabs_a fl'>上架(<?php echo ($count1); ?>)</a>
        <a href="<?php echo U('/Admin/Groupmall/Goods/issale/0');?>" class='<?php if(($issale) == "0"): ?>active<?php endif; ?> tabs_a fl'>下架(<?php echo ($count2); ?>)</a>
      </div>
    </form>
    <!-- end tabs -->
    ...
    <table class="wxtables mgt10" style="text-align:center;">
      ...
      <tbody>
        <?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
            ...
            <td>
              <a href="<?php echo U('/Admin/Groupmall/goodsAddEdit/id');?>/<?php echo ($vo["id"]); ?>" class="btn btn-primary j-editClass">编辑</a>
              <a href="<?php echo U('/Admin/Groupmall/goodsAttribute/id');?>/<?php echo ($vo["id"]); ?>" class="btn btn-primary j-editClass">属性</a>
              ...
              <a href="<?php echo U('/Admin/Groupmall/setSKU/id');?>/<?php echo ($vo["id"]); ?>" class="btn btn-success j-editClass" title="修改">sku&nbsp</a>
              </td>
...
$(".change-status").click(function (){
  ...
  $.post("<?php echo U('Admin/Groupmall/changeStatus');?>", {id:id,item:item}, function(data){
    if(data.status == 1){
...
$(".change-all-status").click(function (){
  ...
  $.post("<?php echo U('Admin/Groupmall/changeAllStatus');?>" ,{ids:ids,item:item}, function (data){
    if(data.status){
      window.location.reload();
    }else{
      alert(data.info);
...
$(".btn_table_delAll").click(function(){
  ...
  $.post("<?php echo U('Admin/Groupmall/delGroupmall');?>" ,{ids:ids}, function (data){
    alert(data.info);
    if(data.status){
      window.location.reload();
    }
