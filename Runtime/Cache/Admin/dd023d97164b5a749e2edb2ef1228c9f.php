...
<title>登陆-<?php echo ($shop_seo_config["title"]); ?>-后台</title>
  ...
  <div class="login-inner">
    ...
    <div class="clearfix mgb10">
      <div class="login-item code fl">
        ...
        <a href="javascript:;" class="clearIpt j-clearIpt"> <i class="gicon-remove"></i></a> </div>
      <div class="code-img fl mgl5"> <img width="30%" id="vcode" class="left15" height="50" alt="验证码" src="<?php echo U('/Admin/User/verify_c',array());?>" title="点击刷新"> </div>
...
$(function () {
    $("#btn_login").click(function () {
        ...
        $.ajax({
            url: "<?php echo U('/admin/User/checkloginajax');?>",
            type: "post",
            dataType: "json",
            data: {
                username: username,
