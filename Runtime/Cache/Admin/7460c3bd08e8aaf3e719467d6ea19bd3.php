...
<div class="inner clearfix"> <div class="content-left fl">
  ...
  <div class="content-right fl">
    ...
    <a href="<?php echo U('/Admin/Goods/addgoods');?>" class="btn btn-success">发布产品</a>
    ...
    <table class="wxtables mgt10" style="text-align:center;">
      ...
      <tbody>
        <?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
            ...
            <td>
              <a href="<?php echo U('/Admin/goods/addgoods/id');?>/<?php echo ($vo["id"]); ?>" class="btn btn-primary j-editClass">编辑</a>
              <a href="<?php echo U('/Admin/goods/attribute/id');?>/<?php echo ($vo["id"]); ?>" class="btn btn-primary j-editClass">属性</a>
              ...
              <a href="<?php echo U('/Admin/goods/goodsskulist/goodsid');?>/<?php echo ($vo["id"]); ?>" class="btn btn-success j-editClass" title="修改">sku&nbsp</a>
              </td>
...
$(".btn_table_delAll").click(function(){
  ...
  $.post("<?php echo U('Admin/goods/delgoods');?>" ,{action:'Del',id:ids}, function (data){
    if (data.status == 1) {
...
$(".change-issale").click(function (){
  var id   = $(this).attr("data-id");
  $.post("<?php echo U('Admin/Goods/delgoods');?>", {action:'changeIssale',id:id}, function(data){
    if(data.status){
      window.location.reload()
    }else{
      alert(data.info);
