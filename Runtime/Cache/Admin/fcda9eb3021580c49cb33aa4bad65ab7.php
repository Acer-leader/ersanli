...
<div class="container">
  ...
  <dl class="left-menu shop_3 sub_tags">
    ...
    <div class="content-right fl">
      <h1 class="content-right-title"><?php echo ($goodsinfo["title"]); ?>属性列表</h1>
      <div class="alert alert-info disable-del"> 目前拥有 <span style="font-size:16px;"><?php echo (count($lists)); ?></span>个属性。
...
$("#examine").click(function(){
    ...
    console.log(data);
    $.post("<?php echo U('Admin/Pointsmall/attributeAddEditDel');?>",data,function(g){
        if(g.status==1){
...
$(".j-delClass").click(function(){   //是否开始结束
    ...
    if(id > 0){
        if(confirm('确定要删除吗？')){
            $.ajax({
                url: "<?php echo U('Admin/Pointsmall/attributeAddEditDel');?>",
                type: "post",
                dataType: "json",
                data: {
                    action:'Del',
