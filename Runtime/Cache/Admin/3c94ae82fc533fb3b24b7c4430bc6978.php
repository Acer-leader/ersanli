  ...
  <dl class="left-menu shop_3 sub_tags">
    ...
    <div class="content-right fl">
      <h1 class="content-right-title">添加信息</h1>
        <form aciton="<?php echo U('/Admin/community/addcommunity');?>" enctype="multipart/form-data" method="post" id="add_step2" onsubmit="return toVaild()">
        <!-- end 基本信息 -->
        ...
        <h3 class="cst_h3 mgb20">信息</h3>
          <div class="formitems">
            ...
            <div class="form-controls">
              ...
              <input type="hidden" value="<?php echo ($info["id"]); ?>" name="id" id="class_id">
              <span class="fi-help-text error"></span> </div>
          </div>
          <div class="formitems">
            <label class="fi-name"><span class="colorRed">*</span>标题：</label>
            <div class="form-controls">
              <input type="text" id="title" class="input xxlarge" name="title" value="<?php echo ($info["title"]); ?>" placeholder="标题" style="width:200px">
              <span class="fi-help-text"></span> </div>
          </div>
          <div class="formitems">
            <label class="fi-name"><span class="colorRed">*</span>副标题：</label>
            <div class="form-controls">
              <input type="text" id="subtitle" class="input xxlarge" name="subtitle" value="<?php echo ($info["subtitle"]); ?>" placeholder="副标题">
              <span class="fi-help-text"></span> </div>
          </div>
          <div class="formitems">
            <label class="fi-name"><span class="colorRed"></span>链接地址：</label>
            <div class="form-controls">
              <input type="text" id="subtitle" class="input xxlarge" name="url" value="<?php echo ($info["url"]); ?>" placeholder="链接地址">
              <span class="fi-help-text"></span> </div>
          </div>
          <div class="formitems">
          ...
          <div class="form-controls pdt5 j-imglistPanel">
            ...
            <ul class="duoxuan_showimge mgr10" id="more_pic" style="position:relative">
                <?php if(is_array($info["pic"])): foreach($info["pic"] as $k=>$vo): ?><img src="<?php echo ($vo); ?>" height="80"  class="mgr10 mgt10 " onclick="delImg(this)">
          ...
          <div class="panel-single panel-single-light mgt20 j-showinhyd" style="display: block;">
            ...
            <div class="formitems">
              ...
              <div class="form-controls">
                <script id="editor" name="content" type="text/plain" style="width:200px;height:500px;"><?php echo (stripslashes(htmlspecialchars_decode($info["content"]))); ?></script>
              </div>
            </div>
          </div>
...
<script type="text/javascript" src="/Public/Admin/Js/lhgcore.js"></script>
<script type="text/javascript" src="/Public/Admin/Js/lhgcalendar.min.js"></script>
