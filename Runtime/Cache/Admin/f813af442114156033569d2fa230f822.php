...
<div class="inner clearfix"> <div class="content-left fl">
  ...
  <div class="content-right fl">
    ...
    <a href="<?php echo U('/Admin/Pointsmall/goodsAddEdit');?>" class="btn btn-success">发布产品</a>
    <form action="<?php echo U('/Admin/Pointsmall/Goods/issale');?>/<?php echo ($issale); ?>" method="post">
    ...
    <table class="wxtables mgt10" style="text-align:center;">
      ...
      <tbody>
        <?php if(is_array($lists)): foreach($lists as $key=>$vo): ?><tr>
            ...
            <td>
              <a href="<?php echo U('/Admin/Pointsmall/goodsAddEdit/id');?>/<?php echo ($vo["id"]); ?>" class="btn btn-primary j-editClass">编辑</a>
              <a href="<?php echo U('/Admin/Pointsmall/goodsAttribute/id');?>/<?php echo ($vo["id"]); ?>" class="btn btn-primary j-editClass">属性</a>
              ...
              <a href="<?php echo U('/Admin/Pointsmall/setSKU/id');?>/<?php echo ($vo["id"]); ?>" class="btn btn-success j-editClass" title="修改">sku&nbsp</a>
              </td>
...
$(".btn_table_delAll").click(function(){
  ...
  $.post("<?php echo U('Admin/Pointsmall/delPointsmall');?>" ,{ids:ids}, function (data){
    alert(data.info);
    if(data.status){
      window.location.reload();
    }
