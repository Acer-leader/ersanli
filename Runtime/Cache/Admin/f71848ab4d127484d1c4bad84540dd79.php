  ...
  <dl class="left-menu shop_3 sub_tags">
    ...
    <div class="content-right fl">
      <h1 class="content-right-title">发布商品</h1>
        <form aciton="<?php echo U('/Admin/Pointsmall/addgoods');?>" enctype="multipart/form-data" method="post" id="add_step2" onsubmit="return toVaild()">
        ...
        <div class="formitems">
          ...
          <div class="form-controls">
            <div class="radio-group">
              <?php if(is_array($malllist)): foreach($malllist as $key=>$vo): if($vo['is'] == 1 ): ?><label><input type="checkbox" name="malltype[]" value="<?php echo ($vo["id"]); ?>" checked="checked" class="shangcheng"><?php echo ($vo["classname"]); ?></label>
                  <?php else: ?> 
                  <label><input type="checkbox" name="malltype[]" value="<?php echo ($vo["id"]); ?>" class="shangcheng"><?php echo ($vo["classname"]); ?></label><?php endif; endforeach; endif; ?>
            </div>
          </div>
        </div>
        <div class="formitems">
          ...
          <div class="form-controls">
            ...
            <input type="text" value="<?php echo ($info["catetitle"]); ?>" id="class_name" style="border: 1px solid #fff;width: 500px;background-color:#fff;" disabled="">
            <input type="hidden" value="<?php echo ($info["cateid"]); ?>" name="cateid" id="class_id">
        ...
        <div class="formitems splikemall" style="display:none">
          ...
          <div class="form-controls">
            ...
            <input type="text" value="<?php echo ($info["timelimittitle"]); ?>" id="timelimittitle" class="input" style="border: 1px solid #fff;background-color:#fff;">
            <input type="hidden" value="<?php echo ($info["timelimitid"]); ?>" name="timelimitid">
            <span class="fi-help-text error"></span> </div>
        </div>
        <div class="formitems">
        ...
        <div class="formitems">
          ...
          <div class="form-controls">
            <input type="text" class="input xxlarge" name="slug" value="<?php echo ($info["slug"]); ?>" placeholder="短标题">
            <span class="fi-help-text"></span> </div>
        </div>
        <div class="formitems">
          <label class="fi-name"><span class="colorRed">*</span>产品副标题：</label>
          <div class="form-controls">
            <input type="text" class="input xxlarge" name="subtitle" value="<?php echo ($info["subtitle"]); ?>" placeholder="产品副标题">
            <span class="fi-help-text"></span> </div>
        </div>
        <div class="formitems">
          <label class="fi-name"><span class="colorRed"></span>供应商：</label>
          <div class="form-controls">
            <input type="text" class="input xxlarge" name="supplier" value="<?php echo ($info["supplier"]); ?>" placeholder="产品副标题">
            <span class="fi-help-text"></span> </div>
        </div>
        <div class="formitems">
        ...
        <div class="formitems">
          ...
          <div class="form-controls">
            <input type="text" class="input mini" name="costprice" value="<?php echo ((isset($info["costprice"]) && ($info["costprice"] !== ""))?($info["costprice"]):0.00); ?>">
            <span class="fi-help-text">注:输入数字(两位小数)</span> </div>
        </div>
        <div class="formitems">
        ...
        <div class="formitems">
          ...
          <div class="form-controls pdt5 j-imglistPanel">
            ...
            <ul class="duoxuan_showimge mgr10" id="more_pic" style="position:relative">
                <!--li style="position:relative;"> <img src="<?php echo ($vo); ?>" height="70" width="90" class="mgr10 mgt10 ">
                    <input type="hidden" name="detailpic[]" value="<?php echo ($vo); ?>">
    ...
    <div class="formitems">
      ...
      <div class="form-controls">
        <select name="selecttimelimitid" class="select">
          <?php if(is_array($timelimitlists)): foreach($timelimitlists as $key=>$vo): ?><option  value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["timelimit"]); ?></option><?php endforeach; endif; ?>
        </select>
        <span class="fi-help-text"></span> </div>
    </div>
  </div>
...
$("#j-selecttimelimitid").click(function(){
    var timelimitid = "<?php echo ($info["timelimitid"]); ?>";
    if(timelimitid){
...
$(function () {
    ...
    $("#baotuan").wrap("<form id='baotuan1' action='<?php echo U('/Admin/Index/addImage');?>' method='post' enctype='multipart/form-data'></form>");
