...
{   //团购商城
    ...
    {   //添加商品
        if($_POST){
            ...
            $data['grouperson']= intval(I('post.grouperson'));
            if($data < 1){
                $this->error('请填写大于0的参团人数');
            }
            ...
            $data['price']          = I('post.price',0,'floor');
            $data['vprice']         = I('post.vprice',0,'floor');
            $data['oprice']         = I('post.oprice',0,'floor');
            ...
            $data['grouphour']      = I('post.grouphour',0,'trim');
